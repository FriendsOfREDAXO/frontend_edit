<?php
/**
 * frontend_edit abstract class - basic functions for the addon and its plugins
 */
abstract class frontend_edit_abstract
{
    /**
     * contains the name of the plugin
     * @var string
     */
    protected static $addon_name = 'frontend_edit';
